...
# =================================================================
# 2. DATA PREPARATION & CLEANING ("The data file, named cleaned_zara_dataset.xlsx, is available on GitHub under the main branch, located on the left-hand side of the repository.")
